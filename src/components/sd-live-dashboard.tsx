  ...
  return (
    <div className="space-y-4">
      ...
      <section className="rounded-lg border border-border bg-card shadow-tile">
        ...
        {showFilters ? (
          <div className="grid gap-2 border-t border-border px-4 py-3 md:grid-cols-2 lg:grid-cols-3">
            <div className="grid grid-cols-1 gap-2 md:col-span-2 md:grid-cols-2 lg:col-span-2">
              ...
              <label className="text-xs text-muted-foreground">
                ...
                <Input
                  ...
                  className="mt-0.5 h-9 w-full max-w-[180px] pr-2 [&::-webkit-calendar-picker-indicator]:mr-0"
                />
              </label>
              <label className="text-xs text-muted-foreground">
                Posting to
